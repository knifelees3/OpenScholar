...
%% 🔹 图1：散点谱
figure;
plot(1:1:15,E(1:15), 'rs', 'MarkerSize', 12, 'MarkerFaceColor','r'); hold on;
hold on
plot(17:1:30,E(17:30), 'rs', 'MarkerSize', 12, 'MarkerFaceColor','r'); hold on;
hold on
plot(16,E(16), 'bs', 'MarkerSize', 12, 'MarkerFaceColor','b'); hold on;
...
for i = 1:num_states
    if i==idx_bic
    plot([0 1], [E(i) E(i)], 'b', 'LineWidth', 3);
    else
